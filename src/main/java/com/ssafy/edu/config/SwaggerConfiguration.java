...
//http://localhost:8080/image/chos.png
	...
	public GroupedOpenApi publicApi() {
		return GroupedOpenApi.builder().group("com.ssafy.edu").pathsToMatch("/api/**").build();
	}
	/*
	@Bean
	...
	public GroupedOpenApi public3Api() {
		return GroupedOpenApi.builder().group("com.ssafy.edu.image").pathsToMatch("/api/boards/**").build();
	}
	*/
}