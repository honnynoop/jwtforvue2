<template>
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="mb-8 flex flex-col md:flex-row gap-4">
        ...
        <router-link
          to="/images/upload"
          class="flex items-center justify-center px-6 py-2 bg-white border border-gray-300 rounded-lg shadow hover:bg-gray-50 transition-colors"
        >
  ...
  const fetchImages = async (page = 1) => {
    try {
      const response = await imageStore.fetchImages({
        page,
        size: pageSize.value,
      ...
      pagination.value = {
        ...
        navigatepageNums: response.navigatepageNums,
